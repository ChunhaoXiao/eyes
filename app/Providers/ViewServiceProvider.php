...
class ViewServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        View::composer(['components/home/shop', 'home.register.create'], function($view) {
        ...
        View::composer('components.home.expertnav', function($view){
            $areas = ShopArea::orderBy('orderid')->get();
            $view->with('areas', $areas);
        });
        
        View::composer('components.home.nav', function($view) {
            $view->with('navs', Nav::top()->orderBy('orderid')->get());
        });
    }
}
