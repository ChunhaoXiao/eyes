...
<div class="container">
    <div class="row">
        <label for="" class="col-sm-auto col-form-label">中心定位</label>
        <div class="col-sm">
    ...
    <div class="row">
        <label for="" class="col-sm-auto col-form-label">活动度</label>
        <div class="col-sm">
    ...
    <div class="row">
        <label for="" class="col-sm-auto col-form-label">移动类型</label>
        <div class="col-sm">
