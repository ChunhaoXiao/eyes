...
<div class="container">
    ...
    <p class="font-weight-bold py-2">加工质量:</p>
    <div class="pl-3">
    ...
    <p class="font-weight-bold py-2">验片试戴：</p>
    <div class="">
        <div class="row">
            <label class="col-sm-1 col-form-label">戴镜视力</label>
        ...
        <div class="row">
            <label class="col-sm-1 col-form-label">居中性</label>
            <div class="col-sm-10">
                <x-radio text="右眼" name="ypsd_jzx_r" :options="[1 => '是', 2 => '否']" :checked="$data->ypsd_jzx_r??1" col="1"/>
            </div>            
        </div>
        <div class="row">
            <label class="col-sm-1 col-form-label"></label>
            <div class="col-sm-10">
                <x-radio text="左眼" name="ypsd_jzx_l" :options="[1 => '是', 2 => '否']" :checked="$data->ypsd_jzx_l??1" col="1"/>
            </div>
            
        </div>

        <div class="row pt-3">
            <label class="col-sm-auto col-form-label">活动度MM</label>
            <div class="col-sm-10">
                <x-radio text="右眼" name="ypsd_dddmm_r" :options="App\Models\Aplastic::HDDMM" :checked="$data->ypsd_dddmm_r??1" col="1"/>
            </div>
        ...
        <div class="row">
            <label class="col-sm-1 col-form-label"></label>
            <div class="col-sm-10">
            <x-radio text="左眼" name="ypsd_dddmm_l" :options="App\Models\Aplastic::HDDMM" :checked="$data->ypsd_dddmm_l??1" col="1"/>
            </div>
        </div>
